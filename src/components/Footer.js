      ...
      <div className="container py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 text-white">
          <div>
            ...
            <div className="grid grid-cols-3">
              ...
              <div>
                <ul className="list-inline">
                  <li className="list-inline-item">
                    <Link target="_blank" href="https://www.facebook.com/solotechnopark.id">
                      <FontAwesomeIcon
                        icon={faFacebook}
                        className="footer-icon smaller-icon"
                        style={{ width: '30px', height: '30px' }}
                  ...
                  <li className="list-inline-item">
                    <Link target="_blank" href="https://www.tiktok.com/@solotechnopark?lang=id-ID">
                      <FontAwesomeIcon
                        icon={faTiktok}
                        className="footer-icon smaller-icon"
                        style={{ width: '30px', height: '30px' }}
              ...
              <div>
                <ul className="list-inline">
                  <li className="list-inline-item">
                    <Link target="_blank" href="https://www.linkedin.com/company/solo-technopark/">
                      <FontAwesomeIcon
                        icon={faLinkedin}
                        className="footer-icon smaller-icon"
                        style={{ width: '30px', height: '30px' }}
                  ...
                  <li className="list-inline-item">
                    <Link target="_blank" href="https://www.youtube.com/channel/UCqtTWpV2tExmQ1pQQLILd2Q">
                      <FontAwesomeIcon
                        icon={faYoutube}
                        className="footer-icon smaller-icon"
                        style={{ width: '30px', height: '30px' }}
          ...
          <div className="mt-5">
            ...
            <Link href="https://s.id/contactsolotechnopark?sid-qr=1" target="_blank">
              <Image className="w-24 mr-0 ml-auto mt-5" src={Barcode} alt="kawasan STP" />
            </Link>
          </div>
        </div>
      </div>
