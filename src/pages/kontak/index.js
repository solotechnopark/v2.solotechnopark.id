...
function Kontak() {
  return (
    <>
      ...
      <NextSeo
        title="Kontak - Solo Technopark"
        description="Butuh  Bantuan ? Kunjungi Kami. Jl. Ki Hajar Dewantara No. 19 Jebres, Kec. Jebres, Kota Surakarta. Email : info@solotechnopark.id. Telepon : (+62) 271 666 628"
        canonical="https://solotechnopark.id/"
        openGraph={{
          url: "https://solotechnopark.id/",
          title: "home | solo technopark",
          description:
            "Butuh  Bantuan ? Kunjungi Kami Kawasan Inovatif dan Berdaya Saing International.",
          images: [
            {
